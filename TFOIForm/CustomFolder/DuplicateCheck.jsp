...
function closeandReturn()
{
	...
	window.parent.handleJSPResponsePPM('DuplicateCheck',"");	
...
<body>
	<FORM name="mainFrm">
		...
		String sQuery="";  
		//sQuery="SELECT WI_NAME FROM EXT_TFO WHERE CUSTOMER_ID ='"+sCustID+"' AND TRANSACTION_CURRENCY='"+sTxnCrncy+"' AND TRANSACTION_AMOUNT='"+sTxnAmnt+"' AND REQUEST_CATEGORY='"+sReqCat+"' AND REQUEST_TYPE='"+sReqType+"' and WI_NAME <>'"+sWiName+"'";
		sQuery = "SELECT WI_NAME FROM TFO_DJ_DEDUP_DTLS WHERE NEW_WI='"+sWiName+"'";	
		System.out.println("QUERY Duplicate Check "+sQuery );
