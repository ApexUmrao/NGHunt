...
public class CPSSendSMSEmail extends DSCOPServiceHandler
{
	...
	public String sendSMSEmail(String sInputXML) 
	{
		...
		try
		{
			...
			Header_Input.setUsername(sCustName);
			...
			String Query="insert into USR_0_CPS_WS_AUDIT(wi_name,userid,request_type,request,requestdatetime,response,responsedatetime,status) values('"+winame+"',( select username from pdbuser a, pdbconnection b   where a.userindex=b.userindex "+
