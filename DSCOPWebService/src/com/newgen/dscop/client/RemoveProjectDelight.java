...
public class RemoveProjectDelight extends DSCOPServiceHandler
{
	...
	public String removeProjectDelight(String sInputXML) 
	{
		LogGEN.writeTrace("CBG_Log", "Function called RemoveProjectDelight");
		LogGEN.writeTrace("CBG_Log", "RemoveProjectDelight sInputXML---");
		...
		try
		{
			...
			ArrayList<String>  wsConfig = WebServiceConfig.getInstance().getCBGWSConfig().get("RemoveProjectDelight");
...
//			String ref_no = xmlDataParser.getValueOf("REF_NO");
			...
			String referenceNumber = xmlDataParser.getValueOf("REF_NO");
			...
			Header_Input.setSysRefNumber(referenceNumber);
