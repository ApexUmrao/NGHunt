...
public class ModIslamicCommodityTransaction extends DSCOPServiceHandler
{
	...
	public String modIslamicCommodityTransactionCall(String sInputXML) 
	{
		LogGEN.writeTrace("CBG_Log", "Function called ModIslamicCommodityTransaction");
		LogGEN.writeTrace("CBG_Log", "ModIslamicCommodityTransaction sInputXML---");
		...
		try
		{
			...
			LogGEN.writeTrace("CBG_Log", "ModIslamicCommodityTransaction xmlInput xml : "+xmlInput);
			request_stub._getServiceClient().getOptions().setTimeOutInMilliSeconds(lTimeOut);
			sOrg_put=request_stub.outputXML;
			LogGEN.writeTrace("CBG_Log", "ModIslamicCommodityTransactionResMsg sOrg_put: "+sOrg_put);
			...
			else
			{
				...
				sOutput="<?xml version=\"1.0\" encoding=\"utf-8\"?><Option>ModIslamicCommodityTransaction</Option><Output><returnCode>"+sReturnCode+"</returnCode><errorDescription>"+sErrorDesc+"</errorDescription><Status>ERROR</Status><td>Unable to modify Commodity Transaction</td></Output>";
			}
		}	
		catch (Exception e)
		{
			...
			sOutput="<?xml version=\"1.0\" encoding=\"utf-8\"?><Option>ModIslamicCommodityTransaction</Option><Output><returnCode>"+sReturnCode+"</returnCode><errorDescription>"+sErrorDesc+"</errorDescription>Unable to modify Commodity Transaction</Output>";
			e.printStackTrace();
		}
		finally
		{
			...
			String Query="insert into USR_0_DSCOP_WS_AUDIT(winame,userid,request_type,request,requestdatetime,response,responsedatetime,status) values('"+winame+"',( select username from pdbuser a, pdbconnection b   where a.userindex=b.userindex "+
					...
					"?,sysdate,'"+  Status + "')";
			LogGEN.writeTrace("CBG_Log","ModIslamicCommodityTransaction  Query : finally :"+Query);
			...
			try {
				...
				LogGEN.writeTrace("CBG_Log","ModIslamicCommodityTransaction  Exception: finally :"+e2.getStackTrace());
			}
		}
		return sOutput;			
	}
