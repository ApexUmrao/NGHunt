...
public class AddDigitalCreditCardSupplRequest extends DSCOPServiceHandler {
	...
	public String AddDigitalCreditCardSupplRequestCall(String sInputXML) 
	{
		...
		try
		{
			...
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard WebServiceConfig Map : "  +wsConfig.toString());
			...
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard WSDL PATH: "+sWSDLPath);
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard CABINET: "+sCabinet);
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard USER: "+sUser);
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard PASSWORD: "+sPassword);
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard LOGIN_REQ: "+sLoginReq);
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard TIME_OUT: "+lTimeOut);
			...
			LogGEN.writeTrace("CBG_Log", "AddDigitalSupplCard suppCount: "+suppCount);
			...
			for (int i=0;i<suppCount;i++)
			{
				...
				String supplDOB = xmlDataParser.getValueOf("supplementaryDOB");
