...
public class ExceptionException extends java.lang.Exception{
    ...
    private com.newgen.dscop.stub.VersionStub.ExceptionE faultMessage;
    ...
    public void setFaultMessage(com.newgen.dscop.stub.VersionStub.ExceptionE msg){
       faultMessage = msg;
    }
    
    public com.newgen.dscop.stub.VersionStub.ExceptionE getFaultMessage(){
       return faultMessage;
    }
}
