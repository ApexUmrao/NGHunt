...
public class SingleUserConnection {
	...
	public String getSession(String cabinetName, String sUsername, String sPassword) throws NGException{
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside getSession");
		String sessionId = "";
		String sessionIdNew = "";
		int isValid = 0;
		int mainCode = 0;
...
//			}
	...
	{				
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside ValidateSession");
	...
	{	
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside makeNewConnection");
		String sessionId="-1";
	...
	{	
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside countAndGetCurrentConnection");
	...
	{		
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside updateConnection");
	...
	{	
		CBGLogMe.logMe(CBGLogMe.LOG_LEVEL_INFO, "Inside deleteConnection");
