...
import com.newgen.ws.request.Commons;
@RunWith(PowerMockRunner.class)
@PrepareForTest({com.newgen.ws.request.Commons.class})
...
public class Test1 {
	...
	public void testFetchCustomerData_Success() throws Exception {
		try {
			...
			String expectedXml = "<?xml version=\"1.0\"?><WFUploadWorkItem_Input><Option>WFUploadWorkItem</Option><EngineName>Engine1</EngineName><SessionId>Session123</SessionId><ValidationRequired></ValidationRequired><ProcessDefId>Process1</ProcessDefId><DataDefName></DataDefName><Documents>Document1</Documents><InitiateFromActivityId>ActId1</InitiateFromActivityId><InitiateFromActivityName>Activity1</InitiateFromActivityName><Attributes>Attribute1</Attributes></WFUploadWorkItem_Input>";
			...
			String outputXml = commons.WFUploadWorkItem(sOption, sEngineName, sSessionID, sProcessDefId,
