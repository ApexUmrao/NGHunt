...
//		processDefId = processdefId;
	...
	//Added by reyaz 
	public static String APDeleteEdms(String tableName, String sWhere, String sessionId,String jtsIP,String jtsPort) throws NumberFormatException, IOException, Exception 
	{
		StringBuilder sInputXML = new StringBuilder(); 
		sInputXML.append("<?xml version=\"1.0\"?>").append("\n")
		.append("<APDelete_Input>").append("\n")
	...
	//added by reyaz  09/06/2023
	public static String APInsertEdms(String tableName,String columnName,String strValues, String sessionId,String jtsIP,String jtsPort) throws NumberFormatException, IOException, Exception
	{
	...
	//added by reyaz
	public static String APSelectEdms(String Query) throws NGException
	{
		StringBuilder sInputXML = new StringBuilder(); 
		sInputXML.append("<?xml version=\"1.0\"?>").append("\n")
		.append("<APSelectWithColumnNames_Input>").append("\n")
	...
	//added by reyaz  09/06/2023
	public static String APUpdateEdms(String tableName, String columnName, String strValues, String whereClause, String sessionId,String jtsIP,String jtsPort) throws NumberFormatException, IOException, Exception
	{
		StringBuilder sInputXML = new StringBuilder(); 
		sInputXML.append("<?xml version=\"1.0\"?>").append("\n")
		.append("<APUpdate_Input>").append("\n")
	...
	public static List getDataFromDB(String columns,String tableName, String whereClause, String tagName){
		...
		try{
			...
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "after split :" +tagNames.length);
			if(mainCode == 0){
				...
				for (int i = 0; i < noOfFields; ++i) {
					...
					for (int j =0; j < tagNames.length; ++j){
						...
						LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "tagValue :" +tagValue);
						outputInner.add(tagValue);
						LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "outputInner :" +outputInner);
					}
					output.add(i,outputInner);
					LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "output :" +output);
				}
			}
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "output GETDATAFROMDB :" +output);
		} catch(Exception e) {
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_ERROR, "error in getDataFromDB: ");
