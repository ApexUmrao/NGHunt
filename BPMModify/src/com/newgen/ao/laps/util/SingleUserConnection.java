...
public class SingleUserConnection {
	...
	public  synchronized String getSession(String cabinetName, String sUsername, String sPassword) 
			throws NGException{
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside getSession");
		String sessionId = "";
		String sessionIdNew = "";
		int isValid = 0;
		int mainCode = 0;
		/*try {
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside try");
			Thread.sleep(5000);
	...
	{				
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside ValidateSession");
	...
	{	
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside makeNewConnection");
		String sessionId="-1";
		...
		if(mainCode == 0){
			...
			try {
				...
				LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside catch InterruptedExceptione"+e.getMessage());
			}
	...
	{	
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside countAndGetCurrentConnection");
	...
	private  int updateConnection(String tableName, String columnNames, String values, String sessionId, int isValid) 
			throws NGException {		
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside updateConnection");
		int mainCode = 0;
		String outputXML;
		if(isValid != 0) {
		...
		try {
			...
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "updateConnection prevTime: " 
					+ prevTime);
			LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "updateConnection sessionUpdateTime: " 
					+ sessionUpdateTime);
	...
	{	
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO, "Inside deleteConnection");
