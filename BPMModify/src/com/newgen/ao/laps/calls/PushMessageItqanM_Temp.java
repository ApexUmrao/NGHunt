...
public class PushMessageItqanM_Temp implements ICallExecutor, Callable<String>{
	...
	public PushMessageItqanM_Temp(String sessionId) {
		...
		String outputXml = "";
		try {
			outputXml = APCallCreateXML.APSelect("SELECT MESSAGE from BPM_QUEUE_MSG ");
		} catch (NGException e) {
	...
	public String call() throws Exception {
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"PushMessage_Temp call: inside");
		String inputXml = "";
		callStatus="Y";
		try {			
	...
	public String createInputXML() throws Exception {
		...
		try {
			...
			.append("<ChannelName>ITQAN_M_TEMP</ChannelName>")
			.append("<PushMessage>")
			.append(message)
			.append("</PushMessage>")
			.append("</APWebService_Input>");
