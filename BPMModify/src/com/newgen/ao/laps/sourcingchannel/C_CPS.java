...
public class C_CPS implements SourcingChannelHandler {
	...
	public LapsModifyResponse dispatchEvent(String sessionId, String channelRefNumber, String correlationNo, 
		...
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"Inside C_CPS");
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"Inside CPS WI: " + wiNumber);
		try {
							...
							if(callEntity.isMandatory()){
								String outputXML = CallHandler.getInstance().executeCall
										(callEntity, attribMap, sessionId, String.valueOf(eventID), 
												wiNumber, false);
								LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"Execute Call:123 outputxml: "
										+ outputXML);
