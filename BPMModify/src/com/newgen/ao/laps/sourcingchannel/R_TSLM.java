...
public class R_TSLM implements SourcingChannelHandler{
	...
	try {
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"Inside R_TSLM");
		...
		LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_INFO,"R_TSLM: status= "+status+"statusDesc= "
				+statusDesc);
		resp.setWiNumber(wiNumber);
		resp.setStatusCode(status);
		resp.setStatusDescription(statusDesc);
		} catch (Exception e) {
						LapsModifyLogger.logMe(LapsModifyLogger.LOG_LEVEL_ERROR, "exception in R_TSLM dispatchEvent: ");
