...
public class ArchivalLogger {
	  ...
	  private static ArchivalLogger instance = new ArchivalLogger();
	  ...
	  public static ArchivalLogger getInstance() {
	    return instance;
	  }

	  private ArchivalLogger() {
	    intitalizeLog();
	  }
	  ...
	  public void intitalizeLog()
	  {
	    try
	    {
	      ...
	      if (log4j == null) {
	        log4j = Logger.getLogger("Archival");
	        log4j.info("Logger is configured successfully");
	      }
	      if (log4jerror == null) {
	        log4jerror = Logger.getLogger("ArchivalError");
