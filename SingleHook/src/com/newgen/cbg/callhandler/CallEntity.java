...
public class CallEntity {
	...
	public String toString() {
		return "CallEntity [stage=" + stage + ", callID=" + callID
				+ ", callName=" + callName + ", isMandatory=" + isMandatory
				+ ", isIgnorable=" + isIgnorable + ", productType="
				+ productType + ", executionType=" + executionType
				+ ", executionSequence=" + executionSequence
				+ ", dependencyCallID=" + dependencyCallID + "]";
	}
}
