...
import com.newgen.cbg.calls.SuppPassportLocalDedupe;
...
public class SuppPassportLocalDedupeTest {
	String s1 = "";
	String s2 = "10";
	String s3 = "10";
	Boolean b = true;
	...
	@Test
	public void testPassportLocalDedupe_Success() throws Exception {
		try {
			...
			String expectedXmlResponse = "<xml><MainCode>0</MainCode><TotalRetrieved>1</TotalRetrieved><PASSPORT_NO>123456</PASSPORT_NO></xml>";
			Mockito.when(mockAPCallCreateXML.APSelect(Mockito.anyString())).thenReturn(expectedXmlResponse);
			SuppPassportLocalDedupe suppPassportLocalDedupe = new SuppPassportLocalDedupe(hm,s1,s2,s3,b,entity);
			String outputXml = suppPassportLocalDedupe.fetchPassportData();
