...
//		processDefId = processdefId;
	...
	public static String APInsertNoLogging(String tableName,String columnName,String strValues, String sessionId) throws NGException
	{
	...
	public static String APTemplateCCM(String wiName, String docCategory) throws NGException
	{
		StringBuilder sInputXML = new StringBuilder(); 
		sInputXML.append("<TemplateGeneration_Input>").append("\n")
		.append("<Option>TemplateGeneration</Option>").append("\n")
		.append("<Data>").append("\n")
		.append("<ProcessName>CBG</ProcessName>").append("\n")
		.append("<WorkitemName>" + wiName + "</WorkitemName>").append("\n")
		.append("<Category>" + docCategory + "</Category>").append("\n")
		.append("</Data>").append("\n")
		.append("</TemplateGeneration_Input>");
		DSCOPLogMe.logMe(DSCOPLogMe.LOG_LEVEL_INFO,"InputXML of templateGen :"+sInputXML.toString());
		String outputXML = TemplateGenSocket.getInstance().connectToSocket(sInputXML.toString());
		return outputXML;   
	}
