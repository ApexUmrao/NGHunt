...
<%
	try
	{
		...
		if(!sWIName.equals(""))
		{
			sQuery= "SELECT CALL_NAME,STATUS,MANDATE_STATUS,RESPONSE,to_char(REQUEST_DATETIME,'dd/mm/yyyy hh:mi:ss')REQUEST_DATETIME,ERRORDESC FROM USR_0_INTEGRATION_CALLS WHERE WI_NAME = '"+sWIName+"' AND ORCHESTRATION_TYPE ='PRE' ORDER BY to_number(CALL_ORDER)";
		}
