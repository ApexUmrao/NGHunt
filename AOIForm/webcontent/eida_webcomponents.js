...
function ReadPublicDataEx(sRefresh, sReadPhotography, sReadNonModifiableData, sReadModifiableData, sSignatureValidation,sReadV2Fields, sReadSignatureImage, sReadAddress)
{
	if(EIDAWebComponent == null)
	{
		alert("The Webcomponent is not initialized.");
	...
	var Ret = EIDAWebComponent.ReadPublicDataEx(sRefresh, sReadPhotography, sReadNonModifiableData, sReadModifiableData, sSignatureValidation,sReadV2Fields, sReadSignatureImage, sReadAddress);
...
function Initialize() 
{
	try
	{
		...
		{
			alert('Eida Driver not found. Please contact Administrator' );
		}
		return Ret;
	}
	catch(e)
...
/*Function to get the data and set.*/
function fetchAllData()
{
	var sPDLabel = "Nationality_PDLabel,FullName_PDLabel,IDNumber_PDLabel,DateOfBirth_PDLabel,PassportNumber_PDLabel,PassportIssueDate_PDLabel,PassportExpiryDate_PDLabel,PassportCountry_PDLabel,MotherFullName_PDLabel,HomeAddress_FlatNumber_PDLabel,HomeAddress_CityDesc_PDLabel,HomeAddress_EmirateDesc_PDLabel,HomeAddress_MobilePhoneNumber_PDLabel,HomeAddress_ResidentPhoneNumber_PDLabel,WorkAddress_Email_PDLabel,OccupationType_PDLabel,Title_PDLabel,CompanyName_PDLabel,Sex_PDLabel,OccupationType_PDLabel,PassportType_PDLabel,ExpiryDate_PDLabel,ResidencyNumber_PDLabel,ResidencyExpiryDate_PDLabel";
	
	var DBColList="EIDA_NATIONALITY,EIDA_FULL_NAME,EIDA_EIDA_NO,EIDA_DOB,EIDA_PASS_NO,EIDA_PASS_ISSUE_DATE,EIDA_PASS_EXP_DATE,EIDA_PASS_ISSUE_PLACE,MOTHER_NAME_EIDA,EIDA_ADDRESS,EIDA_CITY,EIDA_STATE,EIDA_MOBILE_NO,EIDA_PHONE_NO,EIDA_EMAIL,EIDA_PROFESSION,EIDA_PREFIX,EIDA_EMPLYR_NAME,EIDA_GENDER,EIDA_OCC_TYPE,EIDA_PASSPORT_TYPE,EIDA_EXPAIRYDATE,EIDA_VISANO,EIDA_VISAEXPDATE";
	...
	var items = sPDLabel.split(",");
	var colList = DBColList.split(",");
	var FormValues = "";
	...
	{	
		...
		if(v == "-")
			v="";
		FormValues = FormValues + v + "=" + colList[i] ;
...
function DisplayPublicData()
{
	...
	//alert("Ret In DisplayPublic Data--"+Ret);
...
function DisplayPublicDataEx()
{
	...
	//alert("Ret In DisplayPublic DataEx--"+Ret);
	if(Ret.startsWith("-"))
	{
		ProcessError(Ret);
		flag = true;
...
function disableButtons(flag, msg)
{
	...
	try 
	{
		...
		// Added by Amit for making SAVE button disable 
		document.getElementById("btnSaveinDB").disabled = flag;
	}
	catch(e) 
	{
