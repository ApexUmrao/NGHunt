...
public class SaveKYCDetails extends WebServiceHandler
{
	...
	public String saveKYCDetailsStatus(String sInputXML) throws RemoteException
	{
		...
		LogGEN.writeTrace("Log", "Fuction called saveKYCDetailsStatus");
		XMLParser xmlDataParser = new XMLParser();
		LogGEN.writeTrace("Log", sInputXML.replaceAll("&", "and"));
		...
		try
		{
			...
			String sHawala=xmlDataParser.getValueOf("hawala");
