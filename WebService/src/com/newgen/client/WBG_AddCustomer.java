...
public class WBG_AddCustomer extends WebServiceHandler
{
	...
	public String addCustomer(String sInputXML) 
	{
		...
		try
		{
			...
			if(!sErrorDesc.equalsIgnoreCase("Failure") || !sReturnCode.equalsIgnoreCase("1"))
			{
				...
				"<Output>"+
				"<Option>ADD_Customer_WBG</Option>" +
				...
				sOutput="<?xml version=\"1.0\" encoding=\"utf-8\"?><Option>ADD_Customer_WBG</Option><Output><returnCode>"+sReturnCode+"</returnCode><errorDescription>"+sErrorDetail+"</errorDescription><td>Unable to add customer.</td></Output>";
			}	
		}	
		catch (Exception e)
		{
		...
		finally
		{
			...
			try {
				...
				LogGEN.writeTrace("Log","sOrg_Output : finally :"+sOrgResMsg);
