...
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub;
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub.Entities;
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub.ExecuteRuleset;
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub.ExecuteRulesetResponse;
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub.Ikyc_Individual_V1_0_Req;
import com.newgen.stub.Ikyc_Individual_V1_0WebServiceStub.Ikyc_Individual_V1_0_Resp;




public class IndividualRiskbkpsanal10082022 extends WebServiceHandler
{
	 ...
	 */
		...
		public String IndividualRiskCalculate(String sInputXML) 
		{
			...
			try
			{
				...
				Ikyc_Individual_V1_0_Resp Ikyc_Individual_Res;
...
//				Ikyc_Individual_Entity.setIkYC_Risk_Assessment(sRiskAssessment);
				...
				sOrg_Output=iRiskStub.resIkycMsg; //Added By Harish For inserting original mssg
